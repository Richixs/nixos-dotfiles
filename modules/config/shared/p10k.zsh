# Generated by Powerlevel10k configuration wizard on 2026-06-20 at 22:36 -04.
...
# slanted separators, sharp heads, slanted tails, 1 line, compact, many icons, fluent,
...
() {
  ...
  #[ nix_shell: nix shell (https://nixos.org/nixos/nix-pills/developing-with-nix-shell.html) ]##
  # Nix shell color.
  typeset -g POWERLEVEL9K_NIX_SHELL_FOREGROUND=105
  ...
  ##################[ chezmoi_shell: chezmoi shell (https://www.chezmoi.io/) ]##################
  # chezmoi shell color.
  typeset -g POWERLEVEL9K_CHEZMOI_SHELL_FOREGROUND=104
  # Custom icon.
